...
-(void)loadVideoList:(int)page{
    ...
    NSString *url = [NSString stringWithFormat:@"https://api.youku.com/quality/video/by/category.json?client_id=e2306ead120d2e34&cate=1&count=10&page=%d",currentPage];
    [self showHudView];
