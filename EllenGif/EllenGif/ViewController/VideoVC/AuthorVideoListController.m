...
-(void)loadVideoList:(int)page{
    ...
    NSString *url = [NSString stringWithFormat:@"https://openapi.youku.com/v2/videos/by_user.json?client_id=e2306ead120d2e34&user_id=%@&page=%d",_user.ellenId,page];
    [self showHudView];
